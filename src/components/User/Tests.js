...
import '../../css/about_user/tests.scss'
...
export const Tests = () => {
  ...
  return (
    <div className='tests user-container'>
      <div className='test_results'>
        <div className='results_title title_block'>
          ...
          <div className='results_title_right'>
            <h4>Average score:</h4>
            <h1>6.0</h1>
          </div>
        </div>
        <div className='results_number'>
          <div className='results_number_item'>
            <h1>6.0 <span>score</span></h1>
            <h5>Writing section</h5>
          </div>
          <div className='results_number_item'>
            <h1>5.5 <span>score</span></h1>
            <h5>Listening section</h5>
          </div>
          <div className='results_number_item'>
            <h1>6.5 <span>score</span></h1>
      ...
      <div className='all_results'>
        <div className='all_results_title'>
          <h3>Barcha natijalar</h3>
          <div className='all_results_icon_group'>
        ...
        <div className='see_all_results'>
          ...
          <div className='all_results_collapse' >
            <div className='collapse_block'>
              <div className='collapse_body collapse_item' data-bs-toggle="collapse" data-bs-target="#collapse-1" aria-expanded="false" aria-controls="collapseExample">
                <div style={{ display: 'flex', alignItems: 'center' }}>
                  <svg width="12" height="8" viewBox="0 0 12 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M6.0006 4.97656L10.1256 0.851562L11.3039 2.0299L6.0006 7.33323L0.697266 2.0299L1.8756 0.851562L6.0006 4.97656Z" fill="#2D3A45" />
                  </svg>
                  <h6>English FULL test</h6>
                </div>
                <p>15/09/2021</p>
                <span>6.0</span>
            ...
            <div className='collapse_block'>
              <div className='collapse_body collapse_item' data-bs-toggle="collapse" data-bs-target="#collapse-2" aria-expanded="false" aria-controls="collapseExample">
                <div style={{ display: 'flex', alignItems: 'center' }}>
                  <svg width="12" height="8" viewBox="0 0 12 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M6.0006 4.97656L10.1256 0.851562L11.3039 2.0299L6.0006 7.33323L0.697266 2.0299L1.8756 0.851562L6.0006 4.97656Z" fill="#2D3A45" />
                  </svg>
              ...
              <div class="collapse" id="collapse-2">
                <div class="card card-body collapse_body collapse_item_body w-100">
                  ...
                  <p>15/09/2021</p>
                  <span>6.0</span>
                  <Link to='/dsad'>Qayta ishlash</Link>
                </div>
              </div>
            </div>
          </div>
